...
#        """
        ...
        # Precompute lowercased/lstripped forms and leading-space flags once
        # Token views cached once:
        #  _tok_clean:fast prefix filtering
        ...
        allowed_first = []
        if prefix_cmp == "":
            # At BOS prefer non-leading-space; mid-sentence prefer leading-space
        ...
        # Symmetric typed-prefix compatibility (short/long on either side)
        ...
        completed_words: dict[str, float] = {}  # canonical word -> merged logp
...
#                                continue
                        ...
                        if found_alpha and found_word_end:
                            ...
                            # Limit generated letters beyond the typed prefix
